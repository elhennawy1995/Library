...
namespace WindowsFormsApplication2 {
    ...
    public partial class Library2DataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_CATEGORY_CONTAIN_BOOKS;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_CATEGORY_CONTAIN_BOOKS = this.Relations["FK_CATEGORY_CONTAIN_BOOKS"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK_CATEGORY_CONTAIN_BOOKS = new global::System.Data.DataRelation("FK_CATEGORY_CONTAIN_BOOKS", new global::System.Data.DataColumn[] {
                        this.tableBOOKS.B_IDColumn}, new global::System.Data.DataColumn[] {
                        this.tableCATEGORY.B_IDColumn}, false);
            this.Relations.Add(this.relationFK_CATEGORY_CONTAIN_BOOKS);
        }
        ...
        public partial class BOOKSDataTable : global::System.Data.TypedTableBase<BOOKSRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public BOOKSRow AddBOOKSRow(int B_ID, string B_NAME) {
        ...
        public partial class CATEGORYDataTable : global::System.Data.TypedTableBase<CATEGORYRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CATEGORYRow AddCATEGORYRow(int C_ID, BOOKSRow parentBOOKSRowByFK_CATEGORY_CONTAIN_BOOKS, string C_NAME) {
                CATEGORYRow rowCATEGORYRow = ((CATEGORYRow)(this.NewRow()));
                object[] columnValuesArray = new object[] {
                        C_ID,
                        null,
                        C_NAME};
                if ((parentBOOKSRowByFK_CATEGORY_CONTAIN_BOOKS != null)) {
                    columnValuesArray[1] = parentBOOKSRowByFK_CATEGORY_CONTAIN_BOOKS[0];
                }
        ...
        public partial class BOOKSRow : global::System.Data.DataRow {
            ...
            public CATEGORYRow[] GetCATEGORYRows() {
                if ((this.Table.ChildRelations["FK_CATEGORY_CONTAIN_BOOKS"] == null)) {
                    return new CATEGORYRow[0];
                }
                else {
                    return ((CATEGORYRow[])(base.GetChildRows(this.Table.ChildRelations["FK_CATEGORY_CONTAIN_BOOKS"])));
                }
            }
        }
        ...
        public partial class CATEGORYRow : global::System.Data.DataRow {
            ...
            public int B_ID {
                get {
                    return ((int)(this[this.tableCATEGORY.B_IDColumn]));
                }
                set {
                    this[this.tableCATEGORY.B_IDColumn] = value;
                }
            }
            ...
            public BOOKSRow BOOKSRow {
                get {
                    return ((BOOKSRow)(this.GetParentRow(this.Table.ParentRelations["FK_CATEGORY_CONTAIN_BOOKS"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_CATEGORY_CONTAIN_BOOKS"]);
                }
            }
        }
...
namespace WindowsFormsApplication2.Library2DataSetTableAdapters {
    ...
    public partial class BOOKSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[BOOKS] WHERE (([B_ID] = @Original_B_ID) AND ([B_NAME] = @Origi" +
                "nal_B_NAME))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[BOOKS] ([B_ID], [B_NAME]) VALUES (@B_ID, @B_NAME);\r\nSELECT B_I" +
                "D, B_NAME FROM BOOKS WHERE (B_ID = @B_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[BOOKS] SET [B_ID] = @B_ID, [B_NAME] = @B_NAME WHERE (([B_ID] = @Ori" +
                "ginal_B_ID) AND ([B_NAME] = @Original_B_NAME));\r\nSELECT B_ID, B_NAME FROM BOOKS " +
                "WHERE (B_ID = @B_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication2.Properties.Settings.Default.Library2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT B_ID, B_NAME FROM dbo.BOOKS";
        ...
        public virtual int Fill(Library2DataSet.BOOKSDataTable dataTable) {
        ...
        public virtual Library2DataSet.BOOKSDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Library2DataSet.BOOKSDataTable dataTable = new Library2DataSet.BOOKSDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Library2DataSet.BOOKSDataTable dataTable) {
    ...
    public partial class CATEGORYTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[CATEGORY] WHERE (([C_ID] = @Original_C_ID) AND ([B_ID] = @Orig" +
                "inal_B_ID) AND ([C_NAME] = @Original_C_NAME))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[CATEGORY] ([C_ID], [B_ID], [C_NAME]) VALUES (@C_ID, @B_ID, @C_" +
                "NAME);\r\nSELECT C_ID, B_ID, C_NAME FROM CATEGORY WHERE (C_ID = @C_ID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[CATEGORY] SET [C_ID] = @C_ID, [B_ID] = @B_ID, [C_NAME] = @C_NAME WH" +
                "ERE (([C_ID] = @Original_C_ID) AND ([B_ID] = @Original_B_ID) AND ([C_NAME] = @Or" +
                "iginal_C_NAME));\r\nSELECT C_ID, B_ID, C_NAME FROM CATEGORY WHERE (C_ID = @C_ID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT C_ID, B_ID, C_NAME FROM dbo.CATEGORY";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(Library2DataSet.CATEGORYDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual Library2DataSet.CATEGORYDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Library2DataSet.CATEGORYDataTable dataTable = new Library2DataSet.CATEGORYDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Library2DataSet.CATEGORYDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_C_ID, int Original_B_ID, string Original_C_NAME) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int C_ID, int B_ID, string C_NAME) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int C_ID, int B_ID, string C_NAME, int Original_C_ID, int Original_B_ID, string Original_C_NAME) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int B_ID, string C_NAME, int Original_C_ID, int Original_B_ID, string Original_C_NAME) {
            return this.Update(Original_C_ID, B_ID, C_NAME, Original_C_ID, Original_B_ID, Original_C_NAME);
        }
    }
